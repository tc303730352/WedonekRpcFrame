...
namespace RpcModel
{
        public class IRemoteResult : BasicRes
        {
                ...
                {
                        return this._ResultStr != null ? Tools.Json<T>(this._ResultStr) : default;
                }
                public short GetResultByShort()
                {
                        if (this._ResultStr != null)
                        {
                                return short.Parse(this._ResultStr);
                        }
                        return 0;
                }
