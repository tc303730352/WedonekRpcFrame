<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ConfigIndex.aspx.cs" Inherits="Wedonek.Web.Config.ConfigIndex" %>
        ...
        <div class="col-sm-12">
            <form id="QueryForm">
                <div class="form-inline">
                    ...
                    <a class="btn btn-success" href="AddPublicConfig.aspx">添加配置</a>
                </div>
            </form>
        </div>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Js" runat="server">
    ...
    <script type="text/javascript" src="/Js/ConfigIndex.js"></script>
