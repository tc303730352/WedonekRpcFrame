    ...
    JSONEditor.defaults.editors.object = JSONEditor.AbstractEditor.extend({
        ...
        build: function () {
            ...
            // If the object should be rendered as a div
                ...
                this.editjson_textarea.style.height = '400px';
                ...
                $each(this.schema["enum"], function (i, option) {
                    if (self.input_type == "select") {
                        if (typeof (option) == "object") {
                            self.enum_options[i] = "" + option.value;
                            self.enum_display[i] = "" + (display[i] || option.title);
                            self.enum_values[i] = self.typecast(option.value);
                        } else {
                            self.enum_options[i] = "" + option;
                            self.enum_display[i] = "" + (display[i] || option);
                            self.enum_values[i] = self.typecast(i);
                        }
                    }
                    else {
                        self.enum_options[i] = "" + option;
