<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BindServer.aspx.cs" Inherits="Wedonek.Web.RpcMer.BindServer" %>
    ...
    <div class="page-title">
        ...
        <div class="title_right">
            <div class="col-md-5 col-sm-5   form-group pull-right text-right">
                <a class="btn btn-success" href="RpcMerInfo.aspx?id=<%=this.Request.QueryString["Id"] %>">返回</a>
            </div>
        </div>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Js" runat="server">
    ...
    <script type="text/javascript" src="/Js/BindServer.js"></script>
    <script id="ListTemplate" type="text/html">
        ...
        <tr>
            ...
            <td>{{a.IsBind?"已绑定":"未绑定"}}</td>
            <td>{{if a.IsBind ==false}}
                <a href="javascript:_bind({{a.Id}})" class="btn btn-sm btn-info">绑定</a>
                {{else}}
                <a href="javascript:_unbind({{a.BindId}})" class="btn btn-sm btn-danger">解绑</a>
                {{/if}}
            </td>
        </tr>
        {{/each}}
