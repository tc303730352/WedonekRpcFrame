...
namespace HttpWebSocket.Server
{
        internal class SocketServer : ISocketServer
        {
                ...
                private Socket _InitSocket()
                {
                        ...
                        socket.BeginAccept(this._ClientAccept, null);
                        return socket;
                }
                public void Sync()
                {
                ...
                private void _ClientAccept(IAsyncResult ar)
                {
                        ...
                        this._Socket.BeginAccept(this._ClientAccept, null);
                ...
                {
                        _ReplyError(new ApiService(client), error, source);
                }
