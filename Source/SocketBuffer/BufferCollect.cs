...
namespace SocketBuffer
{
        public class BufferCollect
        {
                ...
                public static ISocketBuffer ApplySendBuffer(int size, int pageId)
                {
                ...
                public static ISocketBuffer ApplyBuffer(int size, ISocketBuffer buffer, ref int ver)
                {
                        if (buffer.SourceSize >= size && buffer.SourceSize <= 512)
                        {
