...
namespace SocketTcpServer.FileUp.Collect
{
        internal class FileAccreditCollect
        {
                ...
                private static FileAccredit _AddAccredit(UpFile file, IStreamAllot stream)
                {
                        ...
                        _AccreditList.TryAdd(accredit.PageId, accredit);
                        return accredit;
                }
                ...
                {
                        _FileAccredit.TryAdd(fileId, pageId);
                }
                public static void RemoveBind(string fileId)
                {
                        _FileAccredit.TryRemove(fileId, out _);
                }
