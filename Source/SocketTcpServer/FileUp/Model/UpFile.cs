namespace SocketTcpServer.FileUp.Model
{
        public class UpFile
        {
                ...
                {
                        return SocketHelper.DeserializeStringData(this._Param);
                }
                ...
                public T GetData<T>()
                {
                        ...
                        T data = SocketHelper.DeserializeData<T>(this._Param);
                        this._Data = data;
                        return data;
                }
                public T GetValue<T>() where T : struct
                {
                        ...
                        return (T)SocketHelper.GetValue(typeof(T), this._Param);
                }
        }
}
