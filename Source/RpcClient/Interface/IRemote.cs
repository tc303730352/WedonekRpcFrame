...
namespace RpcClient.Interface
{
        public interface IRemote
        {
                ...
                bool SendFile(IRemoteConfig config, TcpRemoteMsg msg, FileInfo file, UpFileAsync func, UpProgress progress, out UpTask upTask, out string error);

                Dictionary<string, dynamic> ToDictionary(int state);
