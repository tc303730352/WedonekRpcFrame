...
namespace WeDonekRpc.Client.Model
{
        ...
        {
                private readonly Dictionary<string, string> _XmlParam = new Dictionary<string, string>();
                ...
                internal string FindParamShow(MethodInfo method)
                {
