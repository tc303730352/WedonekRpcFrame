<template>
  <el-tabs v-model="activeName" type="border-card" @tab-click="handleClick">
    ...
    <el-tab-pane label="独立配置" name="alone">
      <configList :rpc-mer-id="rpcMerId" :config-name="configName" :service-type="1" :title="'Rpc基础配置'" :edit-view="editView" :add-view="addView" :is-load="activeName == 'alone' && isLoad" />
    </el-tab-pane>
  </el-tabs>
</template>
<script>
...
export default {
  ...
  data() {
    return {
      configName: 'rpc:Config',
      addView: 'rpcBasicFrom',
      editView: 'rpcBasicFrom',
      activeName: 'basic'
    }
  },
  methods: {
