<template>
  <el-tabs v-model="activeName" type="border-card" @tab-click="handleClick">
    ...
    <el-tab-pane label="独立配置" name="alone">
      <configList :rpc-mer-id="rpcMerId" :service-type="1" :config-name="configName" :title="'缓存时间配置'" :edit-view="editView" :add-view="addView" :is-load="activeName == 'alone' && isLoad" />
    </el-tab-pane>
  </el-tabs>
</template>
<script>
...
export default {
  ...
  data() {
    return {
      configName: 'rpc:cacheTime',
      addView: 'cacheTimeFrom',
      editView: 'cacheTimeFrom',
      activeName: 'basic'
    }
  },
  methods: {
