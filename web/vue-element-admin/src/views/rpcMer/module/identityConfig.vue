<template>
  <el-tabs v-model="activeName" type="border-card" @tab-click="handleClick">
    ...
    <el-tab-pane label="独立配置" name="alone">
      <configList :rpc-mer-id="rpcMerId" :service-type="1" :config-name="configName" :title="'租户配置'" :edit-view="editView" :add-view="addView" :is-load="activeName == 'alone' && isLoad" />
    </el-tab-pane>
  </el-tabs>
</template>
<script>
...
export default {
  ...
  data() {
    return {
      configName: 'rpcassembly:Identity',
      addView: 'identityFrom',
      editView: 'identityFrom',
      activeName: 'basic'
    }
  },
  methods: {
